...
## Step 2 — Paste your research

Paste into the chat:

- **Customer research**: interview transcripts, survey results, quotes,
  competitor notes, anything you've gathered.
- **Your proposed solution**: 3–5 sentences describing what you want to
  build.
...
> and proposed solution. Write a PRD for **`<PRODUCT_NAME>`** and save it
> as `docs/prd.md`.
>
...
>      not doing.
> 6. **Already covered by the template** — list every v1/v1.1 feature that
...
> 7. **Success metrics** — one activation metric and one retention metric
>    we can actually measure.
> 8. **Pricing thoughts** — any changes to the Free/Pro split in
>    `lib/stripe/plans.ts`? What should Free users be allowed to do, and
>    what should be gated behind Pro?
> 9. **Open questions** — things the research didn't answer.
>
